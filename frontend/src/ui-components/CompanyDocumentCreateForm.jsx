...
export default function CompanyDocumentCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CompanyDocument(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CompanyDocumentCreateForm")}
      {...rest}
    >
      <TextField
        label="File name"
